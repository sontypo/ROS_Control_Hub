...
declare const ROSLIB: any; // For decodeB64
...
const PointCloudVisualizer: React.FC<PointCloudVisualizerProps> = ({ rosService, topicName }) => {
    ...
    return (
        <div>
            <h3 className="text-lg font-semibold text-cyan-400 mb-2">3D Point Cloud</h3>
            <div ref={mountRef} className="bg-gray-900 rounded-lg h-96 w-full"></div>
        </div>
    );
};
